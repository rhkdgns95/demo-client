...
const useHocUserContext = () => useContext<IContext>(Context);
...
const withHocUser = (WrappedComponent: React.FC): React.FC => {
	const Hoc = () => (
...
export { useHocUserContext };
export default withHocUser;
