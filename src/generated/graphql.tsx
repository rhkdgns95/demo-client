...
export const AllPostsDocument = gql`
  ...
  allPosts(first: $first) {
    ...
    `;
export type AllPostsProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<AllPostsQuery, AllPostsQueryVariables>
    } & TChildProps;
export function withAllPosts<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  AllPostsQuery,
  AllPostsQueryVariables,
  AllPostsProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, AllPostsQuery, AllPostsQueryVariables, AllPostsProps<TChildProps, TDataName>>(AllPostsDocument, {
      alias: 'allPosts',
      ...operationOptions
    });
};
